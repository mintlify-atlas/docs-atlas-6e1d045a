...
- [General Tools](/built-in-tools/general-tools)
...
<CardGroup cols={2}>
  ...
  <Card title="General Tools" icon="toolbox" href="/built-in-tools/general-tools">
    File conversion, diagrams, and web requests
  </Card>
  <Card title="Research Tools" icon="magnifying-glass" href="/built-in-tools/research-tools">
